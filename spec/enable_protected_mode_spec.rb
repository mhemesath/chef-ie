...
describe 'ie::enable_protected_mode' do
  ...
  context 'ie not installed' do
    ...
    it 'should warn if IE not installed' do
      expect(chef_run).to write_log('Recipe ie::enable_protected_mode requires Internet Explorer to be installed!')
    end
  end
